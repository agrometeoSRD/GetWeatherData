...
Description: This is a utils that contains functions that are used in multiple scripts
Created: 2024-02-20
"""
#TODO : make this script a package and available for everywhere within the code
